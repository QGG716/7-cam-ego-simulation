...
r=Path(__file__).resolve().parents[1];out=r/'reports/step2_1b_v3';out.mkdir(parents=True,exist_ok=True);name=sys.argv[1];assert name in ['prepare_worker_v3','apply_refinement_v3','render_worker_v3']
